    ...
    <form onSubmit={handleSubmit} className="app-card p-5 sm:p-6 space-y-4 fade-in">
      ...
      <div>
        ...
        <input
          ...
          className="field-input w-full px-4 py-2.5 border border-zinc-200 rounded-xl text-sm bg-zinc-50/60 font-mono"
        />
        ...
        <p className="text-xs text-zinc-400 mt-1.5 leading-relaxed">
          ...
          and paste it right after <code className="font-mono">placeid=</code> — or paste a full review link to
